...
public:
	...
	void write_potential_file(bool);
	...
	typedef Fingerprint *(*FingerprintCreator)(PairNeuralNet *);
	typedef Activation *(*ActivationCreator)(PairNeuralNet *);
	...
	void chsolve(double *,int,int,double*,double *);
...
private:
	  template <typename T> static Fingerprint *fingerprint_creator(PairNeuralNet *);
	  template <typename T> static Activation *activation_creator(PairNeuralNet *);
};
